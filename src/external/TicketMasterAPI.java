...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "0VRc5QGqkFAMalmixUlJoAAWzxeyiriG";
    ...
    public List<Item> search(double lat, double lon, String keyword) {
    	...
    	//some special char needs to be changed. eg.keyword may contain "",","
    	try {
    		keyword = URLEncoder.encode(keyword, "UTF-8");//CHANGE SPACE TO 20%
    	} catch (Exception e) {
    		e.printStackTrace();
    	}
    	...
    	try {
			...
			//get response code from ticketMaster once sent
			int responseCode = connection.getResponseCode();
			System.out.println("sending 'GET' request to URL: " + URL);
			System.out.println("Response Code: " + responseCode);
			//if not 200, debug above;
			...
			//you're client side.
			//you request to get response(info) from server->inputstream from server to you
			//if you POST sth to server, use outputstream
	...
	private void queryAPI(double lat, double lon) {
		//print out results.NO actual functions
